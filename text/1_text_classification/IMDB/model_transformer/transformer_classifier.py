"""Embedding -> Transformer encoder -> pooling -> sentiment logits.

Unchanged from the AG-News project apart from the two defaults below;
model_transformer/ holds the hand-written encoder this repo uses instead of
...
class TransformerClassifier(nn.Module):
    def __init__(self, vocab_size, num_classes=2, embed_dim=100, dim=128,
                 group=4, num_layers=2, pooling="mean", dropout=0.1,
                 pad_idx=0, max_len=400, norm="post",
        ...
        self.encoder = TransformerEncoder(
            ...
            dropout=dropout, max_len=max_len, norm=norm,
        )
