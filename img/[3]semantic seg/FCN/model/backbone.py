...
So we expose 3 feature maps at strides 8, 16 and 32, and the neck fuses them
into a single stride-8 map (the modern equivalent of FCN-8s' skip
connections).
    ...
    def forward(self, x: torch.Tensor):
        ...
        Output:
            (c3, c4, c5): tuple of 3 feature maps
                c3: [B, 128, H/8,  W/8]   (stride 8,  fine detail, weak semantics)
