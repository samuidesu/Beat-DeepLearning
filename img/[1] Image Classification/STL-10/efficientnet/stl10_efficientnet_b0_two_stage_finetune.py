...
def plot_curves(history, output_dir):
    ...
    plt.ylabel("Loss")
    plt.title("STL-10 EfficientNet-B0 Two-Stage Fine-tuning Loss")
    plt.legend()
    plt.grid(True)
    ...
    plt.xlabel("Global Epoch")
    plt.ylabel("Accuracy")
    plt.title("STL-10 EfficientNet-B0 Two-Stage Fine-tuning Accuracy")
    plt.legend()
    plt.grid(True)
...
def main(args):
    ...
    last_model_path = os.path.join(args.output_dir, "last_efficientnet_b0_two_stage.pth")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="./efficientnet")
