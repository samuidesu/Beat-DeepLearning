"""Inference entry point: run a trained FCOS on image(s) and save the results
with boxes drawn.
...
# This file sits in PASCAL_VOC/detect/, so the project root is its parent's
...
from models.fcos import FCOS  # noqa: E402
...
def parse_args():
    p = argparse.ArgumentParser(description="Run FCOS detection on images")
