"""Backbone: feature extractor for YOLOv3.

This version uses a torchvision **ResNet-18** pretrained on ImageNet as the
backbone. YOLOv3 detects objects at 3 different scales, so the backbone must
expose 3 feature maps at strides 8, 16 and 32.

ResNet-18 layout (for a 416x416 RGB input) and where we tap features:
